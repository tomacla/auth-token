...
import io.github.tomacla.client.app.web.resource.RemoteApiUrlTransformer;
...
public class WebConfiguration extends WebMvcConfigurerAdapter {
	...
	return new RemoteApiUrlTransformer(env.getProperty("client.app.path", "http://localhost:8080/client-app"));
    }
